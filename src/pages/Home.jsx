    ...
    <div>
      ...
      <section className="relative bg-dark-deep min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            <p className="text-xs tracking-[0.5em] uppercase text-gray-text mb-3">TIC ORIGINALS</p>
            <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl text-white font-light tracking-[0.05em]">
              {t('hero.subtitle')}
            </h2>
            <Link to="/products" className="mt-10">
              <Button className="bg-cyan text-dark-deep hover:bg-cyan-dark px-10 py-6 text-xs tracking-[0.2em] uppercase rounded-none">
