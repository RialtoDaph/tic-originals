  ...
  return (
    <div className="bg-white">
      ...
      <section className="grain-overlay bg-dark-deep text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 md:pt-32 md:pb-40">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap items-end justify-between gap-6">
              <p className="text-xs tracking-[0.3em] uppercase text-white/60 max-w-md">
                {lang === 'de' ? 'Streetwear für jene, die niemals aufgeben.' : 'Streetwear for those who never give up.'}
              </p>
              <p className="font-display text-3xl md:text-5xl text-cyan tracking-wider">EST. 2024</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="grid grid-cols-12 gap-6 md:gap-10">
          <motion.div {...fadeUp} className="col-span-12 md:col-span-3">
            <p className="font-display text-[120px] md:text-[180px] leading-[0.8] text-cyan/80">01</p>
            <p className="text-[10px] tracking-[0.4em] uppercase text-gray-text mt-2">Manifesto</p>
          </motion.div>
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.15 }} className="col-span-12 md:col-span-9 md:pt-10">
            <blockquote className="font-heading text-2xl md:text-4xl lg:text-5xl font-light leading-[1.3] italic text-dark">
      ...
      {/* STORY: black block */}
      <section className="grain-overlay bg-dark-deep text-white py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-12 gap-6 md:gap-10">
            <motion.div {...fadeUp} className="col-span-12 md:col-span-3">
              <p className="font-display text-[120px] md:text-[180px] leading-[0.8] text-cyan/80">02</p>
              <p className="text-[10px] tracking-[0.4em] uppercase text-cyan mt-2">
                {lang === 'de' ? 'Biografie' : 'Biography'}
              </p>
            </motion.div>
            <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.15 }} className="col-span-12 md:col-span-9 space-y-6 text-white/80 leading-relaxed md:pt-10">
              <h2 className="font-display text-4xl md:text-6xl text-white uppercase leading-[0.9] mb-8">
              ...
              <div className="pt-6 border-t border-white/10 mt-10">
                <p className="font-display text-3xl md:text-5xl text-cyan uppercase tracking-wide">
                  {lang === 'de' ? '1 World. Eine Vision.' : '1 World. One Vision.'}
                </p>
                <p className="font-display text-2xl md:text-4xl text-white/50 uppercase tracking-wide mt-2">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="grid grid-cols-12 gap-6 md:gap-10 mb-16">
          <motion.div {...fadeUp} className="col-span-12 md:col-span-3">
            <p className="font-display text-[120px] md:text-[180px] leading-[0.8] text-cyan/80">03</p>
            <p className="text-[10px] tracking-[0.4em] uppercase text-gray-text mt-2">Values</p>
          </motion.div>
          <motion.h2 {...fadeUp} transition={{ duration: 0.8, delay: 0.15 }} className="col-span-12 md:col-span-9 font-display text-4xl md:text-6xl lg:text-7xl uppercase leading-[0.9] text-dark-deep md:pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-border">
          {values.map((val, i) => (
            <motion.div
              ...
              className="bg-white p-10 md:p-12 group hover:bg-dark-deep hover:text-white transition-colors duration-500"
            >
              <div className="flex items-start justify-between mb-8">
                <val.icon className="w-6 h-6 text-cyan" strokeWidth={1.5} />
                <span className="font-display text-4xl text-gray-text/40 group-hover:text-white/30 transition-colors">{val.num}</span>
              </div>
              <h3 className="font-display text-3xl md:text-4xl uppercase mb-4 tracking-wide">{val.title}</h3>
      ...
      <section className="grain-overlay bg-cyan py-24 md:py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <motion.div {...fadeUp}>
            <p className="text-[10px] tracking-[0.4em] uppercase text-dark-deep/70 mb-6">
              {lang === 'de' ? 'Bereit für die Bewegung?' : 'Ready for the movement?'}
            </p>
            <h2 className="font-display text-6xl md:text-8xl lg:text-9xl uppercase leading-[0.85] text-dark-deep mb-10">
              NO LIMITS.<br />NO EXCUSES.
            </h2>
            <Link to="/products" className="inline-flex items-center gap-3 bg-dark-deep text-white px-10 py-5 text-xs tracking-[0.25em] uppercase hover:gap-5 transition-all">
