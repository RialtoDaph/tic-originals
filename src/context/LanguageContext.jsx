...
const translations = {
  en: {
    ...
    products: { title: 'Products', all: 'All', filter: 'Filter', search: 'Search products...', size: 'Size', color: 'Color', price: 'Price', addToCart: 'Add to Cart', inStock: 'In Stock', lowStock: 'Low Stock', soldOut: 'Sold Out', inclVat: 'plus 19% VAT · plus shipping', vat: 'VAT 19%' },
  ...
  de: {
    ...
    products: { title: 'Produkte', all: 'Alle', filter: 'Filter', search: 'Produkte suchen...', size: 'Größe', color: 'Farbe', price: 'Preis', addToCart: 'In den Warenkorb', inStock: 'Auf Lager', lowStock: 'Wenig Lager', soldOut: 'Ausverkauft', inclVat: 'zzgl. 19% MwSt · zzgl. Versand', vat: 'MwSt 19%' },
