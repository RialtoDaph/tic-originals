...
const translations = {
  en: {
    ...
    products: { title: 'Products', all: 'All', filter: 'Filter', search: 'Search products...', size: 'Size', color: 'Color', price: 'Price', addToCart: 'Add to Cart', inStock: 'In Stock', lowStock: 'Low Stock', soldOut: 'Sold Out', inclVat: 'No VAT charged (§ 19 UStG — small business)' },
    ...
    checkout: { title: 'Checkout', shipping: 'Shipping Address', method: 'Shipping Method', payment: 'Payment', review: 'Review', firstName: 'First Name', lastName: 'Last Name', street: 'Street', houseNumber: 'House No.', addressLine2: 'Apartment, floor, etc.', addressLine2Hint: 'Optional', postalCode: 'Postal Code', city: 'City', country: 'Country', selectCountry: 'Select country', email: 'Email', phone: 'Phone', placeOrder: 'Place Order', back: 'Back', next: 'Continue', standard: 'Standard (2-5 days)', express: 'Express (1-2 days)', stripe: 'Credit/Debit Card', paypal: 'PayPal' },
    ...
    footer: { newsletter: 'Subscribe to our newsletter', newsletterHeading: 'Newsletter', subscribe: 'Subscribe', legal: 'Legal', impressum: 'Imprint', privacy: 'Privacy Policy', terms: 'Terms & Conditions', withdrawal: 'Right of Withdrawal', payments: 'Payment Methods', followUs: 'Follow Us', service: 'Service', emailPlaceholder: 'Your email address', tagline: 'Till I Collapse. Premium streetwear from Eichstätt, Germany.' },
  ...
  de: {
    ...
    products: { title: 'Produkte', all: 'Alle', filter: 'Filter', search: 'Produkte suchen...', size: 'Größe', color: 'Farbe', price: 'Preis', addToCart: 'In den Warenkorb', inStock: 'Auf Lager', lowStock: 'Wenig Lager', soldOut: 'Ausverkauft', inclVat: 'Gemäß § 19 UStG wird keine Umsatzsteuer berechnet.' },
    ...
    checkout: { title: 'Kasse', shipping: 'Lieferadresse', method: 'Versandart', payment: 'Zahlung', review: 'Überprüfung', firstName: 'Vorname', lastName: 'Nachname', street: 'Straße', houseNumber: 'Hausnr.', addressLine2: 'Wohnung, Stockwerk, etc.', addressLine2Hint: 'Optional', postalCode: 'PLZ', city: 'Stadt', country: 'Land', selectCountry: 'Land auswählen', email: 'E-Mail', phone: 'Telefon', placeOrder: 'Bestellung aufgeben', back: 'Zurück', next: 'Weiter', standard: 'Standard (2-5 Tage)', express: 'Express (1-2 Tage)', stripe: 'Kredit-/Debitkarte', paypal: 'PayPal' },
