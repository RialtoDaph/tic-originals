...
export default function ProductReviews({ productId }) {
  ...
  const labels = {
    en: { title: 'Customer Reviews', write: 'Write a Review', name: 'Your Name', comment: 'Your Review (optional)', submit: 'Submit Review', cancel: 'Cancel', thanks: 'Thank you for your review!', noReviews: 'Be the first to review this product.' },
    de: { title: 'Kundenbewertungen', write: 'Bewertung schreiben', name: 'Dein Name', comment: 'Deine Bewertung (optional)', submit: 'Bewertung absenden', cancel: 'Abbrechen', thanks: 'Danke für deine Bewertung!', noReviews: 'Sei der Erste, der dieses Produkt bewertet.' },
  };
